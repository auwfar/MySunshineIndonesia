...
/**
 * Created by Auwfar on 04-Nov-17.
 */
...
public class WeatherAdapter extends RecyclerView.Adapter<WeatherAdapter.WeatherViewHolder> {
    ...
    class WeatherViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.weather_item_image) ImageView weatherItemImage;
        @BindView(R.id.weather_item_date) TextView weatherItemDate;
        @BindView(R.id.weather_item_desc) TextView weatherItemDesc;
        @BindView(R.id.weather_item_temperature) TextView weatherItemTemperature;
